...
bool hockey_msgs__msg__next_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hockey_msgs.msg._next_path.NextPath", full_classname_dest, 35) == 0);
  }
  hockey_msgs__msg__NextPath * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of NextPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hockey_msgs.msg._next_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NextPath");
